...
public class LanzadordeLanzarComandoCMD {
    public static void main(String[] args) {
        ...
        ProcessBuilder constructorProceso = new ProcessBuilder("java", "Basic.LanzarComandoCMD");
        Process proceso = null;
        File directorio = new File("./target/classes"); //Le decimos donde ejecuta el comando java
